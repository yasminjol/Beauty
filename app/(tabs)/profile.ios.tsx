...
export default function ProfileScreen() {
  ...
  const handleLogoutPress = () => {
    console.log('[Client iOS] Logout button pressed - showing modal');
    Alert.alert('Debug', 'Logout button pressed!');
    setLogoutModalVisible(true);
  };

  const handleConfirmLogout = async () => {
    console.log('[Client iOS] Logout confirmed - calling signOut');
    setLogoutModalVisible(false);
    try {
      await signOut();
      console.log('[Client iOS] ✅ Signed out successfully!');
    } catch (error) {
      console.error('[Client iOS] ❌ Logout error:', error);
      setLogoutModalVisible(true); // Show modal again if logout failed
    }
  };

  const handleCancelLogout = () => {
    console.log('[Client iOS] Logout cancelled');
    setLogoutModalVisible(false);
  };

  console.log('User viewing Profile screen (iOS)');
