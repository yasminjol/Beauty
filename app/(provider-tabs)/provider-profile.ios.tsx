...
export default function ProviderProfileScreen() {
  ...
  const handleLogoutPress = () => {
    console.log('[Provider iOS] Logout button pressed - showing modal');
    Alert.alert('Debug', 'Logout button pressed!');
    setLogoutModalVisible(true);
  };

  const handleConfirmLogout = async () => {
    console.log('[Provider iOS] Logout confirmed - calling signOut');
    setLogoutModalVisible(false);
    try {
      await signOut();
      console.log('[Provider iOS] ✅ Signed out successfully!');
    } catch (error) {
      console.error('[Provider iOS] ❌ Logout error:', error);
      setLogoutModalVisible(true); // Show modal again if logout failed
    }
  };

  const handleCancelLogout = () => {
    console.log('[Provider iOS] Logout cancelled');
    setLogoutModalVisible(false);
  };
